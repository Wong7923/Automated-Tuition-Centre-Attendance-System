...
$teacher = $controller->getProfile($teacherID);
?>
            ...
            <div class="row">
                ...
                <div class="mt-5">
                    <div class="profile-container">
                        ...
                        <p><strong>Subjects:</strong> <?= htmlspecialchars($teacher['subjects']); ?></p>

                        <div class="upload-btn">
                            <form action="../Controller/TeacherProfileController.php" method="POST" enctype="multipart/form-data">
                                <input type="file" name="photo" accept="image/*" class="form-control mt-2" required>
