    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-4">
                <h2 class="mt-4">Student Profile Management</h2>
                <div class="btn-group">
                    <a href="studentProfile.php" class="btn btn-primary" style="border-radius: 6px;">Manage Student Profile</a>  
                    <a href="ViewClassSchedule.php" class="btn btn-primary" style="border-radius: 6px;">View Class Schedule</a>  
                </div>
            </main>
        </div>
    </div>
