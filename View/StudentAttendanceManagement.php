    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-4">
                <h2 class="mt-4">Student Attendance Management</h2>
                <div class="btn-group">
                    <a href="studentAttendanceMarking.php" class="btn btn-primary" style="border-radius: 6px;">Take Attendance</a>  
                    <a href="QRCodeGeneration.php" class="btn btn-primary" style="border-radius: 6px;">QR Attendance</a> 
                    <a href="ViewStudentAttendance.php" class="btn btn-primary" style="border-radius: 6px;">View Student Attendance Record</a>                 
                </div>
            </main>
        </div>
    </div>
